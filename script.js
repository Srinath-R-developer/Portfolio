...
document.querySelectorAll('.project-image').forEach((img, index) => {
    img.style.background = `linear-gradient(135deg, var(--primary-color), var(--secondary-color))`;
    
    // Add project icons/patterns
    const patterns = ['⚡', '🚀', '💡', '🎨', '⭐', '🔥'];
    const icon = document.createElement('div');
    icon.textContent = patterns[index % patterns.length];
    icon.style.cssText = `
        position: absolute;
        top: 50%;
        left: 50%;
...
const fadeElements = document.querySelectorAll('.project-card, .skill-item, .about-stats .stat-item');
